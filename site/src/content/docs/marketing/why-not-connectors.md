...
MailAtlas is useful when you need to parse email into stored records and exported files under your
control. It can start from email files on disk or from a manual IMAP sync into the same workspace.
